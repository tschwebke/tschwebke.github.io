...
## Cleanse Data
```{r Cleanse Data, echo=TRUE, message=FALSE, warning=FALSE}
# reorder columns
...
## Transforms
```{r Transforms, echo=TRUE, message=FALSE, warning=FALSE}
library(plyr)
...
## Attrition Overiew
```{r Attrition Overview, echo=TRUE, message=FALSE, warning=FALSE}
library(ggplot2)
library(gridExtra)
library(scales)
library(ggpubr)
...
```{r Categorical Variable Attrition Plots, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r Continuous Variable Attrition Plots, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r Variable Importance, echo=TRUE, message=FALSE, warning=FALSE}
library(caret)
...
```{r Correlation and multicollinearity, echo=TRUE, message=FALSE, warning=FALSE}
library(corrplot)
library(mosaic)
library(performance)
library(see)
...
## Naive Bayes
```{r Naive Bayes, echo=TRUE, message=FALSE, warning=FALSE}
library(e1071)
library(arsenal)
...
```{r Job Role Specific Trends, echo=TRUE, message=FALSE, warning=FALSE}
# define a vector for all factor variables
role_factors <-
...
```{r Other Interesting Trends, echo=TRUE, message=FALSE, warning=FALSE}
